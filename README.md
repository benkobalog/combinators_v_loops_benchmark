...
3. Play with JVM settings, to see how memory constaints affect the results, because I assume that the map based solutions have a lower memory limit.
4. Try to figure out if Scala does some automatic parallelisation for map,filter,collect, and if yes try to measure with and without it. 
